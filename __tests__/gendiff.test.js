...
const stylishResult = readFile('expected_file_stylish.json');
const plainResult = readFile('expected_file_plain.json');
...
test('Compares JSON files and formats in json', () => {
